  ...
  <div class="container-fluid mt-5"> 
    ...
    <div class="card mb-4"> 
      ...
      <div class="card-body d-sm-flex justify-content-between">
        ...
        <div>
          <a href="{{url('admin/clear-cache')}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Clear Cache</a>         
          <a href="https://ecodevs.com/contact" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-envelope"></i> Contact Developer</a> 
      </div>
      </div>
    </div>
    <!-- Heading --> 
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <br/>
                @if(!empty($settings['site_logo']))<img src="{{url($settings['site_logo'])}}" class="bg-dark" height="32">@endif <br/>
                <br/>
              ...
              <div class="form-group">
                ...
                <br/>
                @if(!empty($settings['site_favicon']))<img src="{{url($settings['site_favicon'])}}" class="bg-dark" height="32">@endif <br/>
                <br/>
                <div class="input-group">
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="ad1" rows="3">{{old('ad1',html_entity_decode($settings['ad1']))}}</textarea>
              </div>
              <div class="form-group">
                <label>Ad Block 2</label>
                <textarea class="form-control" name="ad2" rows="3">{{old('ad2',html_entity_decode($settings['ad2']))}}</textarea>
              </div>
              <div class="form-group">
                <label>Ad Block 3</label>
                <textarea class="form-control" name="ad3" rows="3">{{old('ad3',html_entity_decode($settings['ad3']))}}</textarea>
              </div>
              <div class="form-group">
                <button class="btn btn-success" type="submit">Save</button>
              </div>
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <br/>
                @if(!empty($settings['site_image']))<img src="{{url($settings['site_image'])}}" class="bg-dark" height="32">@endif
                <div class="input-group">
                  <div class="input-group-prepend"> <span class="input-group-text" id="inputGroupFileAddon03">Change Image</span> </div>
                  <div class="custom-file">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="form-group">
                <label>Custom Comments(on/off)</label>
                <br/>
                <div class="custom-control custom-radio custom-control-inline">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="form-group">
                <label>Captcha For Verified Users</label>
                <br/>
                <div class="custom-control custom-radio custom-control-inline">
