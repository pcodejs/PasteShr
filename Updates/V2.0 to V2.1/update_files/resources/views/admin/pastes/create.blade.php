          ...
          <div class="card-body">
            <form method="post" action="">
              ...
              <div class="form-group">
                <label class="font-weight-bold">New Paste
                </label>
                @if(config('settings.paste_editor') == 'ace')
                <textarea id="editor" class="hide">{{old('content')}}
                </textarea>
                <input type="hidden" name="content">
                @else
                <textarea name="content" class="form-control" rows="15" autofocus>{{old('content')}}
                </textarea>
                @endif
              </div>
              <h5>Paste Settings
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="defaultUnchecked" name="encrypted" @if(old('encrypted') == 'on') checked @endif>
