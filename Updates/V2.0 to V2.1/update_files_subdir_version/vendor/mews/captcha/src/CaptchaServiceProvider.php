...
class CaptchaServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../config/custom_captcha.php' => config_path('custom_captcha.php')
        ], 'config');
        ...
        $this->app['validator']->extend('custom_captcha', function ($attribute, $value, $parameters) {
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__ . '/../config/custom_captcha.php', 'custom_captcha'
        );

        // Bind captcha
        $this->app->bind('custom_captcha', function ($app) {
            return new Captcha(
