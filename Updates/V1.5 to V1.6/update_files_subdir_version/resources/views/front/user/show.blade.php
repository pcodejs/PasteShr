      ...
      <div class="col-md-3">
            ...
            <section class="card profile-card mb-4 text-center">
              <div class="avatar z-depth-1-half">
                <img src="{{$user->avatar}}" alt="{{$user->name}}" class="img-fluid" style="width: 120px;">
              </div>
              <!-- Card content -->
              <div class="card-body">
                <!-- Title -->
                ...
                @if($user->status == 1) <p class="green-text font-weight-bold">{{ __('Active')}}</p>
                @elseif($user->status == 0) <p class="blue-text font-weight-bold">{{ __('Pending')}}</p>
                @else <p class="red-text font-weight-bold">{{ __('Banned')}}</p> @endif
                <!-- Social -->
                <a href="{{$user->fb}}" class="btn btn-primary btn-sm waves-effect waves-light"><i class="fa fa-facebook-f white-text"></i></a>
                <a href="{{$user->tw}}" class="btn btn-info btn-sm waves-effect waves-light"><i class="fa fa-twitter white-text"></i></a>
                <a href="{{$user->gp}}" class="btn btn-danger btn-sm waves-effect waves-light"><i class="fa fa-google-plus white-text"></i></a>
