...
class PasteController extends Controller
{
    ...
    {
        $trending_today = Paste::whereDate('created_at',date('Y-m-d'))->orderby('views','DESC')->limit(config('settings.trending_pastes_limit'))->get(['title', 'syntax', 'slug', 'created_at','password','expire_time','views']);        
        ...
        $trending_year = Paste::whereBetween('created_at', [
