          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <br/>
                @if(!empty($settings['site_logo']))<img src="{{$settings['site_logo']}}" class="bg-dark" height="32">@endif <br/>
                <br/>
              ...
              <div class="form-group">
                ...
                <br/>
                @if(!empty($settings['site_favicon']))<img src="{{$settings['site_favicon']}}" class="bg-dark" height="32">@endif <br/>
                <br/>
                <div class="input-group">
