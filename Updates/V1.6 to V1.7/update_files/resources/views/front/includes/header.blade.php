<header> 
  ...
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container"> <a class="navbar-brand" href="{{url('/')}}">@if(!empty(config('settings.site_logo'))) <img src="{{url(config('settings.site_logo'))}}" height="32" alt="{{config('settings.site_name')}}"> @else{{config('settings.site_name')}}@endif</a>
