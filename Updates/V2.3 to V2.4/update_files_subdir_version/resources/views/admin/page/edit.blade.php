    ...
    <div class="card mb-4 "> 
      ...
      <div class="card-body d-sm-flex justify-content-between">
        <h4 class="mb-2 mb-sm-0 pt-1"> 
          ...
          <a href="{{url('admin/pages')}}">{{$page_title}}</a> <span>/</span> 
          <a href="{{$page->url}}" target="_blank">{{$page->title}}</a> <span>/</span> 
          <span>Edit</span> 
        </h4>
      </div>
    </div>
        ...
        <div class="card mb-4"> 
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="form-group">
                <label>Content</label>
                <textarea class="textarea" id="editor" name="content" placeholder="Page content" rows="20">{!!old('content',$page->content)!!}</textarea>
              </div>
              <div class="form-group">
                <label>Active</label>
                @php
