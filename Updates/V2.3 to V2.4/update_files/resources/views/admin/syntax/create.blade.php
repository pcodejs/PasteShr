  ...
  <div class="container mt-5">
    ...
    <div class="card mb-4 "> 
      ...
      <div class="card-body d-sm-flex justify-content-between">
        <h4 class="mb-2 mb-sm-0 pt-1"> <a href="{{url('admin/dashboard')}}">Admin</a> <span>/</span> <a href="{{url('admin/syntax-languages')}}">{{$page_title}}</a> <span>/</span> <span>Create</span> </h4>
      </div>
    </div>
    <!-- Heading --> 
