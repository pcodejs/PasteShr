      ...
      <ul class="navbar-nav d-md-none d-lg-none">
        <li class="nav-item avatar dropdown"> <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-55" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false" title="{{ __('Guest')}}"> <img src="{{url('img/default-avatar.png')}}" class="rounded-circle z-depth-0"
            alt="avatar image" style="height: 32px;"> </a>
          <div class="dropdown-menu dropdown-menu-right dropdown-secondary"
          aria-labelledby="navbarDropdownMenuLink-55"> <a class="dropdown-item" href="{{url('register')}}"><i class="fa fa-user-plus blue-grey-text"></i> {{ __('Sign up')}}</a> <a class="dropdown-item" href="{{url('login')}}"><i class="fa fa-sign-in blue-grey-text"></i> {{ __('Login')}}</a> </div>
        </li>
      </ul>
      @endif
