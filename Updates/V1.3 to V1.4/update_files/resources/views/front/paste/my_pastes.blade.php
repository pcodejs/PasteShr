        ...
        <div class="card">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              <div class="pull-left"> <i class="fa fa-paste small"></i> @if(!empty($paste->password))<i class="fa fa-lock small"></i>@endif @if(!empty($paste->expire_time))<i class="fa fa-clock-o small"></i> @endif <a href="{{$paste->url}}">{{$paste->title_f}}</a>
                <p><small class="text-muted">@if(isset($paste->language)) <a href="{{$paste->language->url}}">{{$paste->language->name}}</a> @else{{$paste->syntax}}@endif | {{$paste->created_ago}}</small></p>
              </div>
