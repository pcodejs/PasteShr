    ...
    <div class="row wow fadeIn" data-wow-delay="0.2s">
      <div class="col-md-8 mx-auto"> 
        ...
        <form class="text-center border border-light p-5" method="post" action="{{route('login')}}">
          ...
          <!-- Email -->
          <input type="text" name="email" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="{{ __('Username / E-mail address')}}" required autofocus>
          ...
          <!-- Sign in button -->
          <button class="btn btn-indigo btn-block my-4" type="submit">{{ __('Sign in')}}</button>
