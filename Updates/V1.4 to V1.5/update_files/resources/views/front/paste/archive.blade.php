    ...
    <div class="row " data-wow-delay="0.2s">
      <div class="col-md-9">
        ...
        <div class="card">
          ...
          @if(Auth::check())<div class=" mx-auto mt-3"> {{$pastes->links()}} </div>@else  <div class="alert alert-warning" role="alert"> <i class="fa fa-info-circle"></i> {{ __('You are currently not logged in')}}, {{ __('this means you can only see limited pastes')}}. <a href="{{url('register')}}">{{ __('Sign Up')}}</a> or <a href="{{url('login')}}">{{ __('Login')}}</a> </div>  @endif
        </div>
      ...
      <div class="col-md-3"> @include('front.paste.recent_pastes') 
