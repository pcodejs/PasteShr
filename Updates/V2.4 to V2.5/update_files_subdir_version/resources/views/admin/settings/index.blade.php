										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" class="custom-control-input" id="codemirror3" name="syntax_highlighter" value="codemirror" @if($settings['syntax_highlighter'] == 'codemirror') checked @endif>
														<label class="custom-control-label" for="codemirror3">Code Mirror </label>
													</div>
												</div>
												<div class="form-group">
