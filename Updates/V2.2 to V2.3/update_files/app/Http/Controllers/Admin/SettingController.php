    ...
    public function update(Request $request)
    {
        ...
        if ($request->type == 'general') {
            ...
            if ($request->hasFile('site_logo')) {
                ...
                if(!empty($old_logo)){
                    if(file_exists(ltrim($old_logo,'/'))) @unlink(ltrim($old_logo,'/'));
                }
            ...
            if ($request->hasFile('site_favicon')) {
                ...
                if(!empty($old_favicon)){
                    if(file_exists(ltrim($old_favicon,'/'))) @unlink(ltrim($old_favicon,'/'));
                }                
            ...
            if ($request->hasFile('background_image')) {
                ...
                if(!empty($old_background_image)){
                    if(file_exists(ltrim($old_background_image,'/'))) @unlink(ltrim($old_background_image,'/'));
                }
            ...
            if ($request->remove_background_image) {
                ...
                Setting::where('key', 'remove_background_image')->update(['value' => '']);
            }
