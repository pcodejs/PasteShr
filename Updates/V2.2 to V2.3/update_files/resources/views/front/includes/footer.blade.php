...
<footer class="page-footer text-center text-md-left mt-0 pt-4"> 
    ...
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-6 ml-auto mb-4">
        ...
        <ul class="list-unstyled">
          <li> <a href="{{route('page.show',['about'])}}">{{ __('About Us')}}</a> </li>
          <li> <a href="{{route('contact')}}">{{ __('Contact Us')}}</a> </li>
          <li> <a href="{{route('page.show',['privacy-policy'])}}">{{ __('Privacy policy')}}</a> </li>
          <li> <a href="{{route('page.show',['terms'])}}">{{ __('Terms of Service')}}</a> </li>
        </ul>
      </div>
      <!--/.Second column-->
      <hr class="w-100 clearfix d-sm-none">
      ...
      <div class="col-lg-3 col-md-6 ml-auto mb-4">
        ...
        <ul class="list-unstyled">
          <li> <a href="{{route('page.show',['faq'])}}">{{ __('FAQ')}}</a> </li>
    ...
    <div class="row"> 
      ...
      <div class="col-md-12 py-3">
        <div class="mb-5 flex-center"> 
          ...
          <a class="ins-ic" href="{{config('settings.social_insta')}}" target="_blank"> <i class="fa fa-instagram fa-lg white-text mr-md-5 mr-3 fa-2x"> </i> </a> @endif
        
          @if(!empty(config('settings.social_pin')))
          <a class="pin-ic" href="{{config('settings.social_pin')}}" target="_blank"> <i class="fa fa-pinterest fa-lg white-text fa-2x"> </i> </a> @endif
        </div>
      </div>
      <!-- Grid column --> 
  ...
  <div class="footer-copyright py-3 text-center">
    <div class="containter-fluid"> © {{date('Y')}} <a href="{{url('/')}}">{{config('settings.site_name')}}</a>. Developed By <a href="mailto:ecodevs@gmail.com">EcoDevs</a></div>
  </div>
  <!--/.Copyright--> 
</footer>
<!--/.Footer--> 
