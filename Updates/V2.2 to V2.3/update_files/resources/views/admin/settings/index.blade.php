          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <small class="text-muted">Default : #f7f7f7</small>
              </div>    
              <div class="form-group">
                ...
                <a href="{{url($settings['background_image'])}}" target="_blank">View</a><br/>
                <br/>@endif 
                <div class="input-group">
                  <div class="input-group-prepend"> 
                    <span class="input-group-text" id="inputGroupFileAddon04">Change Background Image
                    </span> 
                  </div>
                  <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="background_image1">Choose file
                    </label>
                  </div>
                </div>
                <small class="text-muted">Only jpg/jpeg, png files are allowed, Max File Size: 500kb
                </small> 
              </div>
              @if(!empty($settings['background_image']))
              <div class="form-group">
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" for="remove_background_image">Remove Background Image
                  </label>
                </div>
              </div>
              @endif
              ...
              <div class="form-group">
                ...
                <small class="text-muted">To find your timezone 
              ...
              <div class="form-group">
                ...
                <img src="{{url($settings['site_logo'])}}" class="bg-dark" height="32"> <br/>
                <br/>@endif 
                ...
                <small class="text-muted">Only png files are allowed, Max File Size: 200kb, Recommended 200x48
                </small> 
              </div>
              @if(!empty($settings['site_logo']))
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <small class="text-muted">Only png, ico files are allowed, Max File Size: 100kb, Recommended 32x32
                </small> 
              </div>
              <div class="form-group">
                <label>Footer Text
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="navbar1">Fixed
                  </label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="navbar0">Default
                  </label>
                </div>
              </div>              
              <div class="form-group">
            ...
            <form method="post">
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="user_paste1">Yes
                  </label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="user_paste0">No
                  </label>
                </div>
                <br/>
                <small class="text-muted">any user can paste after registration and login
                </small> 
              </div>
              <div class="form-group">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="public_download1">Yes
                  </label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="public_download0">No
                  </label>
                </div>
                <br/>
                <small class="text-muted">anyone can download without registration
                </small> 
              </div>
              <div class="form-group">
                <label>Paste Title Required
                </label>
                <br/>
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="paste_title_required1">Yes
                  </label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <label class="custom-control-label" for="paste_title_required0">No
                  </label>
                </div>
                <br/>
                <small class="text-muted">one must enter title for paste
                </small> 
              </div>
              <div class="form-group">
                <label>Paste Storage
              ...
              <div class="form-group">
                ...
                <small class="text-muted">in seconds
                </small> 
              </div>
              <div class="form-group">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <small class="text-muted">Only png, jpg files are allowed, Max File Size: 200kb
                </small> 
              </div>
              <div class="form-group">
                <button class="btn btn-success" type="submit">Save
