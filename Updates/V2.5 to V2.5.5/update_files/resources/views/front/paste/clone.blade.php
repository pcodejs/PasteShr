              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="{{ __('Paste Title')}}" value="{{old('title',$paste->title)}}" tabindex="5">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="encrypted" name="encrypted" value="1" @if(old('encrypted') == 'on') checked @endif tabindex="8">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="g-recaptcha-response" class="form-control" tabindex="7">
                </div>
                @endif
                @endif                
                <div class="col-md-12">
